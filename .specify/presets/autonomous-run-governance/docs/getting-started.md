...
3. `autonomous-run-governance >=0.4.4` ist aktiv.
...
Erwartet werden Version `0.4.4`, Prioritaet `70` und genau ein Beitrag je
autonomem Befehl.
...
3. `autonomous-run-governance >=0.4.4` is active.
...
Expect version `0.4.4`, priority `70`, and one contribution for each autonomous
command.
