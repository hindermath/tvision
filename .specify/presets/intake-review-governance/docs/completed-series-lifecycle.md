# Lifecycle-Patch 0.2.2 / Lifecycle Patch 0.2.2
...
Rollout-Verbraucher. Version 0.2.2 ist bis zur Veroeffentlichung ein Kandidat.
...
only initial rollout target; 0.2.2 remains a candidate until publication.*
